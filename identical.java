  ...
  private static void preOrder(TreeNode root, StringBuilder preOrder) {
	...
	public boolean isIdentical(TreeNode root1, TreeNode root2) {
		if (root1 == null && root2 == null) {
			...
			return root1.key == root2.key && isIdentical(root1.right, root2.right) && isIdentical(root1.left, root2.left);

		}
	}

    public static void main(String[] args) {
    	identical dark = new identical();
    	TreeNode root1 = TreeNode.reConstruct(new String[] {"5", "3", "#", "#", "8", "#", "#"});
    	TreeNode root2 = TreeNode.reConstruct(new String[] {"5", "2", "#", "#", "8", "#", "#"});
        boolean result = dark.isIdentical(root1, root2);
