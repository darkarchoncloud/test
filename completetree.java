...
public static void main(String[] args) {
  completetree dark = new completetree();
  TreeNode root = null;
  root = TreeNode.reConstruct(new String[] {"5", "3", "1", "#", "#", "4", "#", "#", "8", "#", "11", "#", "#"});
  boolean result = dark.isComplete(root);
  System.out.println(result);
  root = TreeNode.reConstruct(new String[]  {"5", "3", "1", "#", "#", "4", "#", "#", "8", "#", "#"});
  result = dark.isComplete(root);
  System.out.println(result);
  root = TreeNode.reConstruct(new String[]  {"5", "3", "1", "#", "#", "4", "2", "#", "#", "7", "#", "#", "8", "10", "#", "#", "#"});
  result = dark.isComplete(root);
  System.out.println(result);
