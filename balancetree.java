...
public static void main(String[] args) {
	...
	balancetree dark = new balancetree();

	TreeNode root = TreeNode.reConstruct(new String[] {"5", "3", "1", "#", "#", "4", "#", "#", "8", "#", "11", "#", "#"});
    TreeNode root1 = TreeNode.reConstruct(new String[] {"5", "3", "1", "#", "#", "4", "#", "#", "#"});
    boolean result = dark.isBalanced(root);
    boolean result1 = dark.isBalanced(root1);
